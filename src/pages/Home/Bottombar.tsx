...
export default function Bottombar() {
  ...
  return (
    <div
      ...
      className="bgGradient fixed bottom-0 z-50 flex w-full items-center justify-evenly bg-primary py-4 lg:hidden"
    >
      <NavLink to={"/profile"} className="flex items-center justify-center flex-col cursor-pointer space-y-1">
        <Home size={18} className={`${location.pathname === "/profile" ? "text-rose-500" : ""}`} />
